...
public class ReactWheelCurvedPicker extends WheelCurvedPicker {
    ...
    protected void drawForeground(Canvas canvas) {
        ...
        canvas.drawLine(rectCurItem.left, rectCurItem.top-5, rectCurItem.right, rectCurItem.top-5, paint);
        canvas.drawLine(rectCurItem.left, rectCurItem.bottom-5, rectCurItem.right, rectCurItem.bottom-5, paint);
    }
